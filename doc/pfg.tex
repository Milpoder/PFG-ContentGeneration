...
\begin{document}
	...
	%	y agradecimientos).
	%
        \include{pfg_certificado}
        \include{pfg_resumen}
        \include{pfg_palabras_clave}
        \include{pfg_dedicatoria}
        \include{pfg_agradecimientos}
	...
	% FRONTMATTER: TOC, LOF, LOT y descripción/organización de la memoria.
        ...
        \include{pfg_frontmatter_intro}


	% MAINMATTER: El contenido, capítulo a capítulo, de la memoria del PFC.
        \mainmatter

	\include{pfg_main_010}
	\include{pfg_main_020}
	\include{pfg_main_030}
	\include{pfg_main_040}
	\include{pfg_main_050}
	%\include{pfg_main_060}


	% INCLUIMOS LOS APÉNDICES...
        \appendix
	%\include{pfg_appendix_010}
